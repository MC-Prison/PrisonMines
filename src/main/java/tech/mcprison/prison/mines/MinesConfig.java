...
public class MinesConfig {
    ...
    public ArrayList<String> worlds = (ArrayList<String>) Arrays.<String>asList(new String[]{"plots","mines"});
    public ArrayList<Integer> resetWarningTimes = (ArrayList<Integer>) Arrays.<Integer>asList(new Integer[]{600,300,60});
